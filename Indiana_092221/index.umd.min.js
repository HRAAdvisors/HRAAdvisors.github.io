! function(t, n) {
    ...
    var l = function(t) {
        ...
        y = function(t, n) {
            ...
            })).join(" - ") : "+".concat(a[t[0]] || "".concat(t[0]).concat(i)) : t !== null ? a[t] || "".concat(t).concat(i) : a.other || 'other';
        },
        m = {
            color: function(t, e) {
                if (!t) return null;
                ...
                this._map.getStyle().layers.filter((function(t) {
                    ...
                    var i = r.id,
                        ...
                        y = d("details", {
                            ...
                            content: [d("summary", {
                                content: [d("div",{content:u && u.name || i, classes: ['legend-title']})].concat(e(o ? [t._toggleButton(i,k)] : []))
